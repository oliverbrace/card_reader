...
class CardDetailsPage(MDScreen):
    def __init__(self, **kwargs):
        ...
        self.rarity_container = TextWDropdown(
            "What is the rarity of your card?", options=[]
        )
        self.first_edition_container = TextWButtons("Is your card first edition?")
        self.damaged_container = TextWButtons("Is your card damaged?")
        self.notes_container = TextWTextField("Notes")
        done_button = BoxButton(CenteredLabel(text="Yes"))
    ...
    def notes(self):
        ...
        notes_question = CenteredLabel(text="Notes", size_hint=(1, None))
